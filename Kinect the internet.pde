...
void onUpdateHands(int handId, PVector pos, float time) {
  ...
  //swipe
  /*String previous = (String)handVecList.get(1);
  String[] LastGesture = split(previous, " ");
  
  println("PREVIOUS MOVE x: "+LastGesture[0]+" | y: "+LastGesture[1]+" | z: "+LastGesture[2]+" | time: "+LastGesture[3]+" \r");
  
  if((LastGesture[0] / x) > 2 && (LastGesture[3] - time) < 0.3){
    println("SWIPE!!!!!!!!!!!!!!!!!!"); 
  }*/
